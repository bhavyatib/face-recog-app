...
# This python script is called as a separate process when a person signs up.
...
def sendEmail(name,email,code,account_label):
	...
	# Sending the email
	try:
		userEmail='attendancesystembt09@gmail.com'
		userPassword = 'gccbycqbmwpwwadr'
		content = MIMEMultipart()
		content['SUBJECT'] = 'Attendance System E-mail verification'
