...
# This file includes code when a professor uploads photos for taking attendance. A separate process is started, so that the professor can continue to work on his page while the attendance is being recognized.
