...
# This method is called when a student logs in. 
@csrf_exempt
...
# This method is called when a student wants to view a particular course. 
@csrf_exempt
...
# This method is called when the student clicks the view daily report button. 
@csrf_exempt
...
# This method is called when a student wants to view the queries he has raised. 
...
# This method is called when a student enters a query description and raises the query. 
@csrf_exempt
...
# This method is called when a student wants to raise a query. 
...
# This method is called when a student wants to view the history for a particular course on a particular date.
@csrf_exempt
